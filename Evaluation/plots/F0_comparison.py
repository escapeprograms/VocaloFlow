"""F0 comparison: DALI GT conditioning → VocaloFlow inference → F0 overlay plot.
...
all audio files, and plots F0 curves for comparison:
  - DALI GT F0 (step-function from note annotations)
  - SoulX target F0 (extracted from target.wav during preprocessing)
